...
namespace Planetary_REDUCT
{
    class Planetarka
    {
            ...
            double m2, double du, double ag, int LTR1, int LTR2)  // конструктор по диапазонам чисел зубьев и количеств сателлитов
        {
            ...
            double DA, DG, AW1, DR1, DB, DR2, AW2, AW1, DR, AW, Uvr, DUR, Y, YD, D1, D2, Df, ALF, HAZ, CZ;

            void ZVZ1(double SM, int LH)
            {
                ALF = Math.PI / 9;
            ...
            void SV6()
            {
                //procedure SV6(YD, AW1, AW2, SM1:real; var Y:real; var IP:byte);
